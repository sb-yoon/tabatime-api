...
import kr.unlike.tabatime.exception.ValidateException;
...
public class ValidateUtil {
    ...
    public static void password(String userId, String newPwd, String encCurrentPwd) {
        ...
        // throw new ValidateException("비밀번호는 연속적인 문자/숫자(예:111,123,abc)가 포함되지 않게 입력해
        // 주세요.");
        // }
        ...
        // 주세요.");
        // }
        // if (encCurrentPwd != null && SecurityUtil.matchPassword(newPwd,
        // encCurrentPwd)) {
